    ...
    pub mod lobster {
        ...
        impl<'a> MessageEvent<'a> {
            ...
            pub fn timestamp(&self) -> f64 {
                ...
                unsafe {
                    self._tab
                        .get::<f64>(MessageEvent::VT_TIMESTAMP, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn event_type(&self) -> u8 {
                ...
                unsafe {
                    self._tab
                        .get::<u8>(MessageEvent::VT_EVENT_TYPE, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn order_id(&self) -> u64 {
                ...
                unsafe {
                    self._tab
                        .get::<u64>(MessageEvent::VT_ORDER_ID, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn size(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(MessageEvent::VT_SIZE, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn price(&self) -> i64 {
                ...
                unsafe {
                    self._tab
                        .get::<i64>(MessageEvent::VT_PRICE, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn direction(&self) -> i8 {
                ...
                unsafe {
                    self._tab
                        .get::<i8>(MessageEvent::VT_DIRECTION, Some(0))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MessageEventBuilder<'a, 'b, A> {
            ...
            pub fn add_timestamp(&mut self, timestamp: f64) {
                self.fbb_
                    .push_slot::<f64>(MessageEvent::VT_TIMESTAMP, timestamp, 0.0);
            }
            #[inline]
            pub fn add_event_type(&mut self, event_type: u8) {
                self.fbb_
                    .push_slot::<u8>(MessageEvent::VT_EVENT_TYPE, event_type, 0);
            }
            #[inline]
            pub fn add_order_id(&mut self, order_id: u64) {
                self.fbb_
                    .push_slot::<u64>(MessageEvent::VT_ORDER_ID, order_id, 0);
            }
            #[inline]
            ...
            pub fn add_direction(&mut self, direction: i8) {
                self.fbb_
                    .push_slot::<i8>(MessageEvent::VT_DIRECTION, direction, 0);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> MessageEventBuilder<'a, 'b, A> {
        ...
        pub fn root_as_message_event(
            buf: &[u8],
        ) -> Result<MessageEvent, flatbuffers::InvalidFlatbuffer> {
        ...
        pub fn size_prefixed_root_as_message_event(
            buf: &[u8],
        ) -> Result<MessageEvent, flatbuffers::InvalidFlatbuffer> {
        ...
        #[inline]
        pub fn finish_size_prefixed_message_event_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
            fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
            root: flatbuffers::WIPOffset<MessageEvent<'a>>,
        ) {
